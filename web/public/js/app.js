var App = function(){
	...
	this.firebaseConfig = {
		databaseURL : 'https://discipulado-7b14b.firebaseio.com/',
		storageBucket : 'discipulado-7b14b.appspot.com/'
	};
...
$.extend(App.prototype, {
	...
	openPage : function(href){
		...
		// Sets the page's footer
		$("footer").hide();
		
		// Fixes the windows scroll
		$("#main #" + id).show();
		setTimeout(function(){
			window.scrollTo(0, 0);
		}, 1);
	...
	loadBooks : function(obj){
		...
		for(i in obj){
			self.books.collection.push(new Book(obj[i].name, obj[i].cover, obj[i].chapters, obj[i].src, obj[i].info));
		}
		this.pages.home(self.books.collection);
